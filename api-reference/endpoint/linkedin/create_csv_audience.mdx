...
<ParamField body="type" type="string" required>
	Specifies the type of audience upload. Accepted values: COMPANY_LIST_UPLOAD:
	For uploading a list of company names. or USER_LIST_UPLOAD: For uploading a
	list of user identifiers (e.g., emails).
</ParamField>
