...
<Card
	...
	href="/api-reference/endpoint/meta/update_campaign_budget"
>
	Updates the daily budget of a Meta advertising campaign.
</Card>

<Card
	title="📋 Get Campaigns List"
	href="/api-reference/endpoint/meta/get_campaigns_list"
>
	Retrieves a list of all Meta advertising campaigns associated with your ad
	account.
</Card>
