...
description: "This endpoint is used to get page posts from facebook and instagram."
---
...
<ParamField body="pagination" type="string">
	Pagination token for retrieving additional results. Leave empty for the
	first request. Subsequent requests should use the pagination token returned
                ...
                <Expandable title="Posts Array">
                    <Expandable title="Post Object">
                        ...
                        <ResponseField name="mediaType" type="string">
                            The type of media in the post (e.g., "video").
                        </ResponseField>
        ...
        <Expandable title="Results Object">
           ...
           <ResponseField name="posts" type="array">
                <Expandable title="Post Object">
                    ...
                    Type of media in the post (e.g., "VIDEO").
                    </ResponseField>
