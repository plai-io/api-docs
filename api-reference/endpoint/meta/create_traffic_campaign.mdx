...
<ParamField body="multipleCreatives" type="object[]">
    ...
    <Expandable title="Multiple Creative Configuration">
    	...
    	<ParamField body="video" type="object">
    		<Warning>
    			- You have to first upload the video [here](/api-reference/endpoint/meta/upload_video) and then use the video id in the request body or get it from [here](/api-reference/endpoint/meta/get_ad_account_media).
    			- You can get the thumbnail url from the [here](/api-reference/endpoint/meta/get_video_info)
    		</Warning>
